...
- Phase 5 Step 5: 모바일앱 백엔드 Supabase 전환 완료 (외주 개발자 진행), 잔여 기능 오류 수정 중
- Phase 6: 완료 (2026-05) — 카페24·스마일서브 해지, 도메인 등록기관·네임서버 Cloudflare 이전, 메인 사이트 `wooyoopet.com` → GitHub `sueng157/wooyoopet-web` (main) Cloudflare Pages 자동 배포로 교체
