...
| # | 자료 | 상태 | 비고 |
|---|------|------|------|
| 1 | PHP API 소스코드 전체 (/api/*.php) | ✅ 수령 완료 (2026-04-10) | 109파일 (현행 95 + 백업 14), 11,245줄 |
| 2 | MariaDB 스키마 dump | ✅ 수령 완료 (2026-04-10) | 131테이블 (65MB → 146KB 정리) |
| 3 | WebSocket 채팅 서버 소스 | ✅ 수령 완료 | server.py (61줄) + Dockerfile + docker-compose.yml |

### 추가 자료

| # | 자료 | 상태 | 비고 |
|---|------|------|------|
| 4 | API 문서 | ❌ 미수령 | 별도 문서 없음, PHP 소스로 역분석 |
| 5 | 카카오 알림톡 API 키/비즈채널 | ⏳ 수령 대기 | alimtalk.php에서 키 확인 필요 |
| 6 | 카카오 주소 API 키 | ⏳ 수령 대기 | kakao-address.php에서 키 확인 필요 |
| 7 | 이니시스 상용 MID/키 | ⏳ 수령 대기 | 현재 테스트 MID(INIpayTest) 사용중 |
| 8 | Firebase 프로젝트 접근 권한 | ⚠️ 키 교체 필요 | 노출 사고로 인해 재발급 필요 |
...
| 2026-04-11 | 필수 자료 수령 완료 반영 (PHP API 109파일, MariaDB 131테이블, 채팅서버) — 마이그레이션 설계 시작 |
