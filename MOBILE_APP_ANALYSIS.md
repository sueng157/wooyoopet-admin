...
| # | 자료 | 상태 | 비고 |
|---|------|------|------|
| 1 | PHP API 소스코드 전체 (/api/*.php) | ⏳ 요청 완료, 수령 대기 | 62개 엔드포인트 서버 로직 |
| 2 | MariaDB 스키마 dump | ⏳ 요청 완료, 수령 대기 | 테이블 구조만 (데이터 불필요) |
| 3 | WebSocket 채팅 서버 소스 | ⏳ 요청 완료, 수령 대기 | 카페24 서버 채팅 로직 |

### 추가 자료

| # | 자료 | 상태 | 비고 |
|---|------|------|------|
| 4 | API 문서 | ⏳ 요청 완료, 수령 대기 | 있으면 분석 시간 단축 |
| 5 | 카카오 알림톡 API 키/비즈채널 | ⏳ 요청 완료, 수령 대기 | SMS 인증 재구현용 |
| 6 | 카카오 주소 API 키 | ⏳ 요청 완료, 수령 대기 | 주소검색 기능 유지 |
| 7 | 이니시스 상용 MID/키 | ⏳ 요청 완료, 수령 대기 | 실결제 전환 시 |
| 8 | Firebase 프로젝트 접근 권한 | ⏳ 요청 완료, 수령 대기 | FCM 서버 키 확인 |
