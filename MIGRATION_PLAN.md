...
#### 등록 완료 (2026-04-14, R1 추가: 2026-04-18)
...
| `AUTH_WEBHOOK_SECRET` | Supabase Auth SMS Hook 서명 검증용 Webhook Secret | send-alimtalk | ✅ 활성 | 2026-04-18 |
...
> - ⚠️ Supabase CLI는 `SUPABASE_` 접두사 Secret 등록을 차단하므로 (`supabase secrets set` 및 `.env` 모두 불가), Webhook Secret은 `AUTH_WEBHOOK_SECRET` 이름으로 등록함.
