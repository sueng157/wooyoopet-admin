...
| `JUSO_CONFM_KEY` | 행안부 주소 API 승인키 | address-proxy | 2026-04-14 |
| `NAVER_MAP_CLIENT_ID` | 네이버 역지오코딩 API Client ID (NCP) | address-proxy | 2026-04-14 |
| `NAVER_MAP_CLIENT_SECRET` | 네이버 역지오코딩 API Client Secret (NCP) | address-proxy | 2026-04-14 |
